...
\GXNSFHeading{研究背景与科学意义}

\GXNSFSubheading{平台化传播形成复杂动态系统}
...
\GXNSFHeading{国内外研究现状与不足}

\GXNSFSubheading{职业阶段研究缺少平台耦合机制}
...
\GXNSFSubheading{计算社会科学提供方法但存在割裂}
...
\GXNSFSubheading{韧性研究缺少可反驳的边界条件}
...
\GXNSFHeading{本项目的切入点}

\GXNSFSubheading{从公开事件链转向多层状态空间}
